...
type EmbeddingTaskType = "search_query" | "search_document" | "clustering" | "classification";
/**
 ...
 */
interface NomicEmbeddingsParams extends EmbeddingsParams {
  /**
   * The API key to use.
...
interface NomicEmbeddingsResult {
 ...
 */
declare class NomicEmbeddings extends Embeddings implements NomicEmbeddingsParams {
  modelName: string;
  model: string;
  taskType: EmbeddingTaskType;
  batchSize: number;
...
//#endregion
export { EmbeddingTaskType, NomicEmbeddings, NomicEmbeddingsParams, NomicEmbeddingsResult };
